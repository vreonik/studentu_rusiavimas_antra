    /**
     * @file test_struct_vs_class.cpp
     * @brief Struct vs Class spartos palyginimo testas
     *
     * Šiame faile yra funkcijos skirtos palyginti struct ir class versijų
     * našumą naudojant Strategiją 3 (greičiausią).
     */
     ...
     * @brief Detalių testavimo rezultatų struktūra
     */
    struct DetalusTestoRezultatai {
        long long skaitymo_laikas;  ///< Failo skaitymo laikas
        long long skirstymo_laikas; ///< Studentų skirstymo laikas
        long long bendras_laikas;   ///< Bendra operacijos trukmė
        size_t vargsiukai;          ///< Vargsiukų skaičius
        size_t kietakiai;           ///< Kietakių skaičius
    };

    /**
     * @brief Testuoti struct versiją su Strategija 3
     * @param failoVardas Testuojamo failo pavadinimas
     * @return Detalus testavimo rezultatai
     */
    ...
    /**
     * @brief Testuoti class versiją su Strategija 3
     * @param failoVardas Testuojamo failo pavadinimas
     * @return Detalus testavimo rezultatai
     */
    ...
    /**
     * @brief Testuoti su konkrečiu failu
     * @param failoVardas Testuojamo failo pavadinimas
     * @param testu_kartai Testų iteracijų skaičius
     */
    ...
    /**
     * @brief Testuoti su sugeneruotais failais
     * @param testu_kartai Testų iteracijų skaičius
     */
    ...
    /**
     * @brief Pagrindinė testavimo funkcija
     */
