    /**
     * @file konteineriu_testavimas.cpp
     * @brief Konteinerių testavimo implementacijos
     *
     * Šiame faile yra implementacijos skirtos testuoti ir palyginti
     * skirtingus konteinerių tipus ir rūšiavimo strategijas.
     */
    ...
    /**
     * @brief Testuoti konkrečią strategiją su vidurkių skaičiavimu
     * @param fname Įvestinio failo pavadinimas
     * @param b Skaičiavimo metodas
     * @param rikiuoti_kriterijus Rūšiavimo kriterijus
     * @param testu_kartai Testų iteracijų skaičius
     * @param rezultatai Išvesties failo srautas rezultatams
     * @param strategijos_nr Strategijos numeris (1-3)
     */
    ...
    /**
     * @brief Testuoti visas tris strategijas su konkrečiu failu
     * @param fname Įvestinio failo pavadinimas
     */
