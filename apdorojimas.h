    /**
     * @file apdorojimas.h
     * @brief Pagrindinės studentų duomenų apdorojimo funkcijos
     *
     * Šiame header faile pateikiamos šabloninės funkcijos studentų duomenų
     * apdorojimui, klasifikavimui ir išvedimui. Apima laiko ir atminties
     * matavimo galimybes.
     */
    ...
    /**
     * @brief Spausdinti studentų duomenų peržiūrą
     * @tparam Container Konteinerio tipas (vector, list)
     * @param visi_stud Konteineris su visais studentais
     * @param pasirinkimas Skaičiavimo metodas: 'v' vidurkis, 'm' mediana
     * @param limitas Rodomų studentų skaičius (numatytasis: 10)
     */
    ...
    /**
     * @brief Klasifikuoti studentus ir įrašyti į failus su laiko matavimu
     * @tparam Container Konteinerio tipas (vector, list)
     * @param visi_stud Konteineris su visais studentais
     * @param pasirinkimas Skaičiavimo metodas: 'v' vidurkis, 'm' mediana, 'a' abu
     * @param failas_vargsiukai Išvesties failas silpniems studentams
     * @param failas_kietakiai Išvesties failas stipriems studentams
     * @param skirstymo_ms Nuoroda, kurioje saugomas klasifikavimo laikas ms
     * @param rusiavimo_ms Nuoroda, kurioje saugomas rūšiavimo laikas ms
     * @param irasymo_ms Nuoroda, kurioje saugomas įrašymo laikas ms
     * @param rikiuoti_kriterijus Rūšiavimo kriterijus: 'v' vidurkis, 'm' mediana, 'p' vardas
     */
    template<typename Container>
    ...
    /**
     * @brief Apdoroti failą su laiko matavimais
     * @tparam Container Konteinerio tipas (vector, list)
     * @param fname Įvestinio failo pavadinimas
     * @param budas Skaičiavimo metodas: 'v' vidurkis, 'm' mediana, 'a' abu
     * @param rikiavimas Rūšiavimo kriterijus: 'v' vidurkis, 'm' mediana, 'p' vardas
     */
    template<typename Container>
