    /**
     * @file main.cpp
     * @brief Pagrindinė programos dalis su meniu ir testavimo funkcijomis
     *
     * Šiame faile yra pagrindinė programos funkcija, meniu sistema
     * ir pagalbinės testavimo funkcijos.
     */
    ...
    /**
     * @brief Testuoti programą su įvairiais duomenų dydžiais
     */
    void testuoti_programa();

    /**
     * @brief Testuoti strategijas su skirtingais failais
     */
    void testuoti_strategijas();

    /**
     * @brief Naudoti konkrečią strategiją su failu
     */
    void naudoti_strategija_su_failu();

    /**
     * @brief Pagrindinė programos funkcija
     * @return Programos grąžinimo kodas
     */
    int main() {
    ...
    /**
     * @brief Optimizuotas failo nuskaitymas į konteinerį
     * @tparam Container Konteinerio tipas
     * @param fname Įvestinio failo pavadinimas
     * @return Konteineris su studentų duomenimis
     */
